...
### Added
- `VoyageReranker` for the multilingual `rerank-2.5` API, including bounded
  retries, response validation, environment-based credentials, and a stable
...
[Unreleased]: https://github.com/nuhatech/maktaba/compare/v0.3.2...HEAD
[0.3.2]: https://github.com/nuhatech/maktaba/compare/v0.3.1...v0.3.2
[0.3.1]: https://github.com/nuhatech/maktaba/compare/v0.3.0...v0.3.1
